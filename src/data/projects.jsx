export default [
  {
    ...
    thumbnail: "/img/pdferslogo.png",
    tags: ["React", "Next.js", "Python"],
    overview: "PDFファイルを様々な形式（Word、Excel、PowerPoint、画像など）に変換するWebサービスです。ユーザーは簡単なドラッグ&ドロップ操作でファイルをアップロードし、数秒で変換されたファイルをダウンロードできます。SEO最適化とGoogle AdSenseを活用した収益化モデルを検討し、持続可能なビジネス運営を目指しています。",
    technologies: [
      "React 18 - モダンなUI構築",
      "Next.js 13 - SSR/SSGによる高速化",
      "Python - ファイル変換処理",
